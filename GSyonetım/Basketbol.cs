...
namespace GSyonetım
{
    public partial class Basketbol : Form
    {
        ...
        {
            basketbolcu basketbolcuForm = new basketbolcu();
            basketbolcuForm.StartPosition = FormStartPosition.Manual;
            basketbolcuForm.Location = new Point(100, 100); // Manuel konum ayarı
            basketbolcuForm.Show();

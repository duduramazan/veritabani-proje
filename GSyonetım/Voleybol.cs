...
namespace GSyonetım
{
    public partial class Voleybol : Form
    {
        ...
        {
            voleybolcu voleybolcuForm = new voleybolcu();
            voleybolcuForm.StartPosition = FormStartPosition.Manual;
            voleybolcuForm.Location = new Point(100, 100); // Manuel konum ayarı
            voleybolcuForm.Show();
